...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 50 --180   --default 20 to 90
TRAJECTORY_BUILDER_2D.min_range = 0.2 --0.3
TRAJECTORY_BUILDER_2D.max_range = 24. --25.
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 0.1 --200.
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 0.01 --400.
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.1  --default 5 to 0.1
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.001 --defualt 0.2 to 0.001
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.01) --default 2 to 0.01

POSE_GRAPH.optimize_every_n_nodes = 1e2--30 --default 20 to 90
MAP_BUILDER.num_background_threads = 90 --6

POSE_GRAPH.global_sampling_ratio = 0.003

-- POSE_GRAPH.mapping_mode = false -- Jcan

POSE_GRAPH.constraint_builder.sampling_ratio = 0.4 --0.2 to 0.4
...
POSE_GRAPH.optimization_problem.local_slam_pose_rotation_weight = 1e3 --မပြင်သေး 1e1
POSE_GRAPH.optimization_problem.local_slam_pose_translation_weight = 1e3 --မပြင်သေး 1e1  

POSE_GRAPH.optimization_problem.odometry_translation_weight = 1e3    --မပြင်သေး 1e1
POSE_GRAPH.optimization_problem.odometry_rotation_weight = 1e3 --မပြင်သေး 1e1

POSE_GRAPH.global_constraint_search_after_n_seconds = 30--500 --from 250 to 500
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.linear_search_window = 0.5 --0.05
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.rad(10.) -- 10. to 0.5
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.branch_and_bound_depth = 7
POSE_GRAPH.max_num_final_iterations = 200

POSE_GRAPH.constraint_builder.ceres_scan_matcher.translation_weight = 3. --40
POSE_GRAPH.constraint_builder.ceres_scan_matcher.rotation_weight = 0.01   --10.
