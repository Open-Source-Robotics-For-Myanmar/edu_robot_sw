    ...
    /// ၂။ မြေပုံ save ပါ။
        ...
        if(ret_code == 0) 
        {
            ...
            std::string cmd2 = "ros2 run cartographer_ros cartographer_pbstream_to_ros_map "
                               ...
                               "mv /home/buc_robot/software_ws/map.pgm " + package_directory + map_name + ".pgm 2>/dev/null || true && "
                               "mv /home/buc_robot/software_ws/map.yaml " + package_directory + map_name + ".yaml 2>/dev/null || true";
