...
const std::string sourceFile =
    "/home/mr_robot/data/trees/tree_nodes_models.xml";
...
void construct_xml_file(
  ...
  if (request_mode == "waypoints_mode") {
    ...
    const std::string yaml_path =
        "/home/mr_robot/data/waypoints/waypoints_mode.yaml";
    ...
    const std::string yaml_path =
        "/home/mr_robot/data/waypoints/service_mode.yaml";
    rom_interfaces::msg::ConstructYaml message;
    ...
    const std::string yaml_path =
        "/home/mr_robot/data/waypoints/patrol_mode.yaml";
    rom_interfaces::msg::ConstructYaml message;
    ...
    const std::string yaml_path =
        "/home/mr_robot/data/waypoints/path_mode.yaml";
