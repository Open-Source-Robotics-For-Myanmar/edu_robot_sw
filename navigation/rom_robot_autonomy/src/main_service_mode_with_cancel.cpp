...
const std::string bt_xml_file = "/home/buc_robot/data/trees/service_mode.xml";
const std::string waypoints_yaml_file = "/home/buc_robot/data/waypoints/service_mode.yaml";
