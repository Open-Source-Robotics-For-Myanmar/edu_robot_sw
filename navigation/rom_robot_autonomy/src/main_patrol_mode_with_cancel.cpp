...
const std::string bt_xml_file = "/home/mr_robot/data/trees/patrol_mode.xml";
const std::string waypoints_yaml_file = "/home/mr_robot/data/waypoints/patrol_mode.yaml";
