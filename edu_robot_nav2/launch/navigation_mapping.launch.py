...
def generate_launch_description():
    ...
    # ns ကြောင့် ဖျက်ဖို့ လိုကောင်းလိုမယ်။
    remapping = []
    ...
    declare_namespace_cmd = DeclareLaunchArgument(
        'namespace',
        default_value=rom_robot_namespace,
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            PushRosNamespace(rom_robot_namespace) if rom_robot_namespace else SetEnvironmentVariable('_DUMMY', '1'),
            Node(
            ...
            Node(
                ...
                parameters=[configured_params],
                arguments=['--ros-args', '--log-level', log_level],
                remappings=remapping+ [('cmd_vel_smoothed', 'cmd_vel_smoother_to_collision'), ('cmd_vel', 'cmd_vel_collision')]),
        ]
    )

    lifecycle_manager_nav = GroupAction(
        actions=[
            PushRosNamespace(rom_robot_namespace) if rom_robot_namespace else SetEnvironmentVariable('_DUMMY', '1'),
            Node(
